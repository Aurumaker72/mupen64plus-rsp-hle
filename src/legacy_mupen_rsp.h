...
#define LEGACY_PLUGIN_TYPE_RSP				1
#define LEGACY_PLUGIN_TYPE_GFX				2
#define LEGACY_PLUGIN_TYPE_AUDIO			3
#define LEGACY_PLUGIN_TYPE_CONTROLLER		4
...
/******************************************************************
  ...
  output:   none
*******************************************************************/
__declspec(dllexport) void GetDllInfo(LEGACY_PLUGIN_INFO* PluginInfo);
...
/******************************************************************
  ...
  output:   none
*******************************************************************/
__declspec(dllexport) void GetRspDebugInfo(LEGACY_RSPDEBUG_INFO* RSPDebugInfo);
...
/******************************************************************
  ...
  output:   none
*******************************************************************/
__declspec(dllexport) void InitiateRSP(LEGACY_RSP_INFO Rsp_Info, uint32_t* CycleCount);
...
/******************************************************************
  ...
  output:   none
*******************************************************************/
__declspec(dllexport) void InitiateRSPDebugger(LEGACY_DEBUG_INFO DebugInfo);
